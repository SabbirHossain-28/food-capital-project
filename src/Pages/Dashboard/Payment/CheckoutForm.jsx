...
const CheckoutForm = () => {
  ...
  return (
    <div>
        ...
        <div>
          <div className="text-center mt-8 mb-4">
            <h2 className="text-2xl font-semibold underline">
              Successful TransactionId list
            </h2>
          </div>
          <div className="flex justify-center">
            <ol>
              <li className="text-xl font-medium list-decimal">
                Transaction Id:
      ...
      {error && (
        <div className="flex w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800 mt-4">
